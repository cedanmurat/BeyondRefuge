...
public class NationalismActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.add(new News("Adam Sand", "Nationalism", "01.01.2018", "A quick and simplified answer is that Lorem Ipsum refers to text that the DTP (Desktop Publishing) industry use as replacement text when the real text is not available.", "http://www.google.com", R.drawable.image2));
        newsList.add(new News("Adam Sand", "Nationalism", "01.01.2018", "A quick and simplified answer is that Lorem Ipsum refers to text that the DTP (Desktop Publishing) industry use as replacement text when the real text is not available.", "http://www.urfanatik.com", R.drawable.image3));
